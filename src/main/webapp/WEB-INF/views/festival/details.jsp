...
<br>
LISTA EVENTÓW:<br>
1. impreza czwartkowa - <a href="/event/details">szczegóły</a> - <a href="/event/edit">[edytuj(superadminOnly)]</a> - <a href="/event/delete">[usuń(superadminOnly)]</a><br>
2. impreza piątkowa - <a href="/event/details">szczegóły</a> - <a href="/event/edit">[edytuj(superadminOnly)]</a> - <a href="/event/delete">[usuń(superadminOnly)]</a><br>
<br>
...
[docelowo ta funkcjonalność ma być podpięta pod googleDocs - maile będe wysyłać się automatycznie po rejestracji i dzień przed festiwalem]
